...
export const Navbar = () => {
    ...
    return (
        <nav className="w-full mx-auto bg-white shadow ">
            <div className="container px-6 justify-between h-16 flex items-center lg:items-stretch mx-auto nav-wrapper">
                    ...
                    <div className="mr-10 flex items-center">
                        <h3 className="text-base text-white font-bold tracking-normal leading-tight ml-3 hidden lg:block">
                            <span className="relative inline-block px-6 py-2">
                                ...
                                <a href="#" className="relative text-teal-900">
                                    <Link href="/dashboard">I-MKT</Link>
                                </a>
                            </span>
                        </h3>
                    </div>
