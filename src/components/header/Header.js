                ...
                <div className="relative max-w-2xl sm:mx-auto sm:max-w-xl md:max-w-2xl sm:text-center">
                    ...
                    <form className="flex flex-col items-center w-full mb-4 md:flex-row md:px-16">
                        ...
                        <Link href="/post">
                            <a
                                href="#"
                                className="inline-flex items-center justify-center w-full h-12 px-6 font-semibold tracking-wide text-teal-900 transition duration-200 rounded shadow-md md:mr-1 hover:text-deep-purple-900 bg-teal-accent-400 hover:bg-teal-accent-700 focus:shadow-outline focus:outline-none"
                            >
                                Post Job
                            </a>
                        </Link>
